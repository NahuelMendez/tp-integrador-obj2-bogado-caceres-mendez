...
public class FixtureUsuarioNovatoTest {
	...
	public FixtureUsuarioNovatoTest() {
		...
		when(muestra2.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra3 = mock(Muestra.class);
		when(muestra3.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra4 = mock(Muestra.class);
		when(muestra4.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra5 = mock(Muestra.class);
		when(muestra5.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra6 = mock(Muestra.class);
		when(muestra6.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra7 = mock(Muestra.class);
		when(muestra7.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra8 = mock(Muestra.class);
		when(muestra8.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra9 = mock(Muestra.class);
		when(muestra9.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra10 = mock(Muestra.class);
		when(muestra10.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra11 = mock(Muestra.class);
		when(muestra11.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra12 = mock(Muestra.class);
		when(muestra12.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra13 = mock(Muestra.class);
		when(muestra13.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra14 = mock(Muestra.class);
		when(muestra14.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra15 = mock(Muestra.class);
		when(muestra15.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra16 = mock(Muestra.class);
		when(muestra16.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra17 = mock(Muestra.class);
		when(muestra17.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra18 = mock(Muestra.class);
		when(muestra18.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra19 = mock(Muestra.class);
		when(muestra19.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
		muestra20 = mock(Muestra.class);
		when(muestra20.usuarioEsAptoParaVotar(usuarioN)).thenReturn(true);
